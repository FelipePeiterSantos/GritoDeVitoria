...
function scene:enterScene( event )
	...
	char.x,char.y = display.contentWidth/2,display.contentHeight-120;char.anchorY=1--; char:setFillColor(.2,0,.5)
	goalk.x,goalk.y = display.contentWidth/2,display.contentHeight-65; goalk.anchorY=1--:setFillColor(.2,.5,.5)
	top.y = 0
	for i=1,3 do 
		if i==1 then
...
function scene:exitScene( event )
	...
	timer.performWithDelay(1,function () storyboard.purgeScene("stage4_1") end)
end
